...
CREATE OR REPLACE FUNCTION f_trigger_bloques() 
RETURNS TRIGGER 
AS 
$$
    BEGIN
...
CREATE TRIGGER trigger_bloques
AFTER INSERT OR UPDATE OR DELETE ON bloques
	FOR EACH ROW EXECUTE FUNCTION f_trigger_bloques();